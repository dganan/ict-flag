...
public class AuthorizationManagerTest
{
	...
	private void setupPermissions(IAuthorizationRepository authorizationRepository, IUserRepository userRepository) throws Exception
	{
		...
		urp.setModule("institution");
		urp.setEntity("Program");
		urp.setPermissions(Arrays.asList(Permission.READ, Permission.EDIT));
		...
		when(authorizationRepository.userRolePageAccessExists(UserRole.PROGRAM_MANAGER, "/private/EditProgram.xhtml")).thenReturn(true);
	...
	public void userHasPermissionTest() throws Exception
	{
		...
		assertTrue(manager.userHasPermission("pm1", "institution", "Program", Permission.EDIT));
		...
		assertTrue(manager.userHasPermission(ui3, "institution", "Program", Permission.EDIT));
	...
	public void userHasPageAccessTest() throws Exception
	{
		...
		assertTrue(manager.userHasPageAccess("pm1", "/private/EditProgram.xhtml"));
